      ...
      <div className="container">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <address className="not-italic space-y-3 text-gray-300">
              <p className="flex items-start gap-2">
                ...
                <span>Saint Isidore Church, Manila, Philippines</span>
              </p>
              <p className="flex items-start gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mt-1 flex-shrink-0">
          ...
          <div>
            ...
            <p className="text-sm text-gray-300 mb-4">Subscribe to get updates about our performances and events.</p>
            <form className="space-y-2">
              <input
                type="email"
                placeholder="Your email"
                className="w-full px-4 py-2 rounded bg-gray-800 border border-gray-700 text-white focus:outline-none focus:ring-2 focus:ring-sice-orange"
              />
              <button
                type="submit"
                className="w-full bg-sice-orange hover:bg-sice-darkOrange transition-colors text-white font-medium py-2 rounded"
              >
                Subscribe
              </button>
            </form>
